...
mortalityData_split = initial_split(mortalityData, strata = group). ###3 we gotta look up this strata 
...
mortality_workFlow = add_formula(workflow(), group ~ .)
...
collect_metrics(mortality_final) 
